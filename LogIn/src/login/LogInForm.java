...
public class LogInForm extends javax.swing.JFrame {
    ...
    private void passwordStrengthIndicator(){
        ...
        boolean hasAtLeast6To8Chars = password.length() >= 6 && password.length() < 8;
        boolean hasAtLeast5Chars = password.length() <= 5;
        
        boolean isStrongPassword = hasAtLeast8Chars; //&& hasUpperCase && hasLowerCase && hasDigit && hasSpecialChar;
        boolean isMediumPassword = hasAtLeast6To8Chars; //&& hasUpperCase && hasLowerCase && hasDigit && hasSpecialChar;
        boolean isWeakPassword = hasAtLeast5Chars;// && hasUpperCase && hasLowerCase && hasDigit && hasSpecialChar;
        
        if(isStrongPassword){
            jLabel4.setForeground(Color.GREEN);
           jLabel4.setText("your password is Strong" );
        }else if(isMediumPassword){
            jLabel4.setForeground(Color.ORANGE);
           jLabel4.setText("your password Strength is medium");
        }else if(isWeakPassword){
           jLabel4.setForeground(Color.RED);
           jLabel4.setText("your password Strength is weak"); 
        }else{
            jLabel4.setText(" ");
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("E:\\Java Programming internship\\resize2.png")); // NOI18N
        ...
        jCheckBox1.setFont(new java.awt.Font("Courier New", 1, 14)); // NOI18N
